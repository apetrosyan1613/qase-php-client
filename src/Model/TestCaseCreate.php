...
/**
 * TestCaseCreate Class Doc Comment
 *
 * @category Class
 * @package  Qase\Client
 * @author   OpenAPI Generator team
 ...
 */
class TestCaseCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TestCaseCreate';
    ...
    protected static $openAPITypes = [
        ...
        'status' => 'int',
        'attachments' => 'string[]',
        'steps' => '\Qase\Client\Model\TestCaseCreateSteps[]',
        'tags' => 'string[]',
    ...
    public function setTitle($title)
    {
        if ((mb_strlen($title) > 255)) {
            throw new \InvalidArgumentException('invalid length for $title when calling TestCaseCreate., must be smaller than or equal to 255.');
        }
