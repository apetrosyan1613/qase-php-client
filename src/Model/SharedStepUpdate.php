...
/**
 * SharedStepUpdate Class Doc Comment
 *
 * @category Class
 * @package  Qase\Client
 * @author   OpenAPI Generator team
 ...
 */
class SharedStepUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SharedStepUpdate';
    ...
    public function setTitle($title)
    {
        if ((mb_strlen($title) > 255)) {
            throw new \InvalidArgumentException('invalid length for $title when calling SharedStepUpdate., must be smaller than or equal to 255.');
        }
     ...
     * Gets steps
     *
     * @return \Qase\Client\Model\SharedStepCreateSteps[]|null
     */
     ...
     * Sets steps
     *
     * @param \Qase\Client\Model\SharedStepCreateSteps[]|null $steps steps
     *
     * @return self
     */
