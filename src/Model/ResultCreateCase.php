...
/**
 * ResultCreateCase Class Doc Comment
 *
 * @category Class
...
class ResultCreateCase implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['suiteTitle'] = $data['suiteTitle'] ?? null;
     ...
     * @return string|null
     */
    public function getSuiteTitle()
    {
        return $this->container['suiteTitle'];
    }

    /**
     * Sets suiteTitle
     *
     * @param string|null $suiteTitle Nested suites should be separated with `TAB` symbol.
     *
     * @return self
     */
